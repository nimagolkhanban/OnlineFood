...
MIDDLEWARE = [
    ...
    # tip: to have access to request in the order model we have to create a custom middleware
...
EMAIL_HOST_USER = '33a99284a18a0b'
EMAIL_HOST_PASSWORD = '51eaaf25e03205'
EMAIL_PORT = '2525'